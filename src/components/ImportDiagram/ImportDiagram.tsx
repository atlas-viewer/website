...
export const ImportDiagram: React.FC = () => (
  <svg width="100%" viewBox="0 0 401 305" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <filter x="-40.7%" y="-75.3%" width="181.5%" height="250.6%" filterUnits="objectBoundingBox" id="import-a">
    ...
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g transform="translate(-76.000000, -724.000000)">
        <g transform="translate(112.000000, 724.000000)">
          <g opacity={0.8} filter="url(#import-a)" transform="translate(0.000000, 60.000000)">
